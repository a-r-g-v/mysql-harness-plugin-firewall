...
extern const string kDefaultErrorLogFilePath;
extern const string kDefaultQueryLogFilePath;

extern const string kDefaultLearnFilePath;
extern const int kDefaultLearnMode;
extern const int kDefaultLoggingQuery;
extern const int kDefaultFillErrorMessage;
extern const int kDefaultBlackListDetection;
extern const string kDefaultBlackListWordListFile;
