...
const string kDefaultErrorLogFilePath = "/tmp/firewall-error.log";
const string kDefaultQueryLogFilePath = "/tmp/firewall-query.log";
const string kDefaultLearnFilePath = "/tmp/firewall-learn.log";
const string kDefaultBlackListWordFilePath = "/tmp/blacklist";
const int kDefaultLearnMode = 0;
const int kDefaultLoggingQuery = 0;
const int kDefaultFillErrorMessage = 0;
const int kDefaultBlackListDetection = 0;
